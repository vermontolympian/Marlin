...
// Fan Tachometers
#define HAS_TACH_FAN0 (HAS_FAN0 && PIN_EXISTS(FAN0_TACH))
#define HAS_TACH_FAN1 (HAS_FAN1 && PIN_EXISTS(FAN1_TACH))
#define HAS_TACH_FAN2 (HAS_FAN2 && PIN_EXISTS(FAN2_TACH))
#define HAS_TACH_CONTROLLER_FAN (HAS_CONTROLLER_FAN && PIN_EXISTS(CONTROLLER_FAN_TACH))
#define HAS_TACH_AUTO_FAN_0 (HAS_AUTO_FAN_0 && PIN_EXISTS(E0_AUTO_FAN_TACH))
#define HAS_TACH_AUTO_FAN_1 (HAS_AUTO_FAN_1 && PIN_EXISTS(E1_AUTO_FAN_TACH))
#define HAS_TACH_AUTO_FAN_2 (HAS_AUTO_FAN_2 && PIN_EXISTS(E2_AUTO_FAN_TACH))
#define HAS_TACH_AUTO_FAN_3 (HAS_AUTO_FAN_3 && PIN_EXISTS(E3_AUTO_FAN_TACH))
#define HAS_TACH_AUTO_FAN_4 (HAS_AUTO_FAN_4 && PIN_EXISTS(E4_AUTO_FAN_TACH))
#define HAS_TACH_AUTO_FAN_5 (HAS_AUTO_FAN_5 && PIN_EXISTS(E5_AUTO_FAN_TACH))
#define HAS_TACH_AUTO_CHAMBER_FAN (HAS_AUTO_CHAMBER_FAN && PIN_EXISTS(CHAMBER_AUTO_FAN))
